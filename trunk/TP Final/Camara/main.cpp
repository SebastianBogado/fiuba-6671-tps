...
void botonMouse(int boton,int estado,int x,int y){

        contrloadorCamara->controladorBotonesMouse(boton,estado,x,y);
}

void movMouse(int x,int y){
        contrloadorCamara->controladorMovMouse(x,y);
}

int main(int argc, char** argv)
{
        //TestRotador testRotador;
       // testRotador.iniciar();
