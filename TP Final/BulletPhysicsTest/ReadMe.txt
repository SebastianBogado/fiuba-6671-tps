========================================================================
    APLICACIÓN DE CONSOLA: BulletPhysicsTest 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación BulletPhysicsTest.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación BulletPhysicsTest.


BulletPhysicsTest.vcxproj
...
BulletPhysicsTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado BulletPhysicsTest.pch y un archivo de tipos 
